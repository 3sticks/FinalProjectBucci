...
public class SommelierTab extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,  ViewGroup container,  Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.sommeiler, container, false); //creates a view object and calls the tab layout for sommeiler when this class is used
        return view;
    }
}
