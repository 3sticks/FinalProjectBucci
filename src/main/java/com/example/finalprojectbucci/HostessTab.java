...
public class HostessTab extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,  ViewGroup container,  Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.hostess, container, false); //creates a view object and calls the tab layout for hostess when this class is used
        return view;
    }
}
