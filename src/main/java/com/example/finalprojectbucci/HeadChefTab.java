...
public class HeadChefTab extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,  ViewGroup container,  Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.head_chef, container, false); //creates a view object and calls the tab layout for head chef when this class is used
        return view;
    }
}
