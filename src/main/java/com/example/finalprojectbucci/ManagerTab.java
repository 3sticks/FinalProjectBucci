...
public class ManagerTab extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,  ViewGroup container,  Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.manager, container, false); //creates a view object and calls the tab layout for manager when this class is used
        return view;
    }
}
